...
function HeroSection(){
    return(
        <div className="h-auto md:-h[40] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
            <div className="py-4 relative z-10 w-full text-center justify-center">
                <Spotlight
